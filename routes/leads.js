...
router.patch('/update', autherization.protect, autherization.authorize('admin', 'employee','employee-2', 'manager'), leadController.updateLead);
router.patch('/delete', autherization.protect, autherization.authorize('admin', 'employee', 'employee-2', 'manager'), leadController.deleteLead);
